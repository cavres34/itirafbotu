  ...
  if event.is_private:
    async for usr in client.iter_participants(event.chat_id):
     ...
     return await event.reply(f"{ad} {startmesaj}", buttons=(
                      ...
                      [Button.url('📜 İtiraf Kanalı', f'https://t.me/hossohbetleritirafkanal')],
                      [Button.url('📣 Destek', f'https://t.me/hossohbetleritirafkanal'),
                       Button.url('👨🏻‍💻 Sahibim', f'https://t.me/rahatsizetmeyiniz')]
                    ),
                    link_preview=False)
